...
const Board = () => {
    ...
    const { columns, columnsOrder } = useSelector((state: DefaultRootStateProps) => state.kanban);
    // handle drag & drop
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            <DragDropContext onDragEnd={onDragEnd}>
                <Droppable droppableId="columns" direction="horizontal" type="column" isDropDisabled>
                    {(provided, snapshot) => (
                        <MainCard
                            border={false}
